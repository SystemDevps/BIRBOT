...
app.config['SQLALCHEMY_DATABASE_URI'] = 'sqlite:///systembot.db'
...
class Log(db.Model):
    ...
    # Puedes agregar un campo para la zona horaria si es necesario
...
def verificar_token(req):
    ...
    if challenge and token == TOKEN_SYSTEMDEVPS:
        return challenge
    else:
